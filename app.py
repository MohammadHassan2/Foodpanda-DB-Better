...
# -----------------------------------------------------------------------------
# VIEW 4: REACTIVE UI - PLACE DYNAMIC ORDER
# -----------------------------------------------------------------------------
elif menu == "Place Order":
    st.header("🛵 Place a Basic Order")
    
    # Fetch base active data
    ...
    if customers.empty or restaurants.empty:
        ...
        if menu_items.empty:
            ...
            if active_riders.empty:
                ...
                # Randomly pick an active rider to simulate dispatch logistics
                ...
                if st.button("Confirm Order"):
                    ...
                    # Insert into Order_Details (associative entity)
                    ...
                    # Auto-generate a live tracking session
                    ...
                    st.balloons()
                    st.success(f"Order #{new_ord_id} successfully created, linked to tracking, and assigned to {assigned_rider['Full_Name']}!")